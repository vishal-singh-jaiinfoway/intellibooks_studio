...
export default function TestimonialContent() {
  ...
  return (
    <NioSwiper
      ...
      navClass="swiper-button-group-s1 text-success w-100 has-bg justify-content-center d-none d-lg-inline-flex mb-md-n1 text-success"
      breakpoints={{
                    ...
                    <div className="nk-testimonial-content">
                      <div className="media-group media-group-column pb-5">
                        ...
                        <div className="media-text">
                          ...
                          <span className="small text-base font-bold">
                      ...
                      <NioBadge
                        label="Quotes"
                        className="fs-12 text-bg-success text-white text-uppercase rounded-pill mb-1 mb-md-4"
                      />
